...
db.Order.insertOne({
    ...
    'order':[
        ...
        {'order_id':'r2o3', 'restaurant_id':2, 'food_id':3, 'deliver':0,'taken':false},
    ]
})
db.Order.insertOne({
    'customer_id':2,
    ...
    'order':[
        ...
        {'order_id':'r1o3', 'restaurant_id':1, 'food_id':2, 'deliver':0,'taken':false},
    ]
})
db.Order.insertOne({
    'customer_id':3,
    ...
    'order':[
        ...
        {'order_id':'r1o2', 'restaurant_id':1, 'food_id':1, 'deliver':0,'taken':false},
        {'order_id':'r3o3', 'restaurant_id':3, 'food_id':3, 'deliver':0,'taken':false},
    ]
})